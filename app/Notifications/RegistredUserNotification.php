...
class RegistredUserNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->success()
                    ->subject('Cration de votre compte Car-Ticket.')
                    ->from('cart-ticket@gesi-ci.com', 'Car-Ticket')
                    ->line("Votre compte Car-Ticket a bien été crée mais il doit être confirmé. Merci de cliquer sur le bouton suivant.")
